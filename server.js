...
//process GET request for changing colors of home page
...
//proccess post request for adding colors
...
app.get('/player_info/select_player', function(req, res) {
	var id = req.query.player_choice; //maybe id
  console.log(id)
